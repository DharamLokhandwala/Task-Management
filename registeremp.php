...
$username_err = $password_err = $confirm_password_err = $name_err = $dept_name_err = $service_err = "";
...
if($_SERVER["REQUEST_METHOD"] == "POST") { 
   ...
   /* if(empty(trim($_POST["service"])))
    ...
    if(empty($username_err) && empty($password_err) && empty($confirm_password_err) && empty($name_err) && empty($dept_name_err))
	{
        ...
        $employee_insert = "INSERT INTO employee (name, username,email) VALUES ('$name','$username','$email')" ;
        $employee_insert2 = "INSERT INTO userinfo VALUES ('$username','$param_password',0)" ;
		//$conn->query($employee_insert);
		//mysqli_query($conn,$employee_insert);
		
        if(mysqli_query($conn, $employee_insert) && mysqli_query($conn, $employee_insert2)){
            // Bind variables to the prepared statement as parameters
...
<header>
    ...
    <section class="wrapper container">
        ...
        <div class="col s12 l3 ">
            <h1 class="center" style="font-family: 'Bowlby One SC', cursive; padding-top:120px;">Fill Employee Details</h1>
        </div>
